...
(() => {
  ...
  async function open() {
    ...
    content.querySelector("#coachTeam").onchange=()=>{refreshCompetition();refreshSeason();refreshOpponent();draw();};
    content.querySelector("#coachCompetition").onchange=()=>{refreshSeason();refreshOpponent();draw();};
    content.querySelector("#coachSeason").onchange=()=>{refreshOpponent();draw();};
    ["coachVenue","coachOpponent","coachRole","coachMinutes"].forEach(id=>content.querySelector("#"+id).onchange=draw);
    refreshCompetition();refreshSeason();refreshOpponent();draw();drawOps();
  }
