...
function openPilotDashboard(){
  ...
  modal.innerHTML=`<div class="modalCard productHome"><button class="modalX">×</button>
    <div class="productHero"><div><small class="eyebrow">COURTIQ · CLUB INTELLIGENCE</small><h2>Maccabi Bnot Ashdod</h2><p>2026–27 Pilot Workspace</p></div><div class="pilotBadge"><span>● PILOT ACTIVE</span><b>BUILD 091</b></div></div>
