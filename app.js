...
function openPilotDashboard(){
  ...
  modal.innerHTML=`<div class="modalCard productHome"><button class="modalX">×</button>
    <div class="productHero"><div><small class="eyebrow">COURTIQ · CLUB INTELLIGENCE</small><h2>Maccabi Bnot Ashdod</h2><p>2026–27 Pilot Workspace</p></div><div class="pilotBadge"><span>● PILOT ACTIVE</span><b>BUILD 088</b></div></div>
...
async function openGameLibrary(){
  ...
  modal.innerHTML=`<div class="modalCard compareModal gameLibrary"><button class="modalX">×</button>
    ...
    <div class="gameLibraryGrid">${items.length?items.map(([key,g])=>`<button class="gameLibraryCard" data-library-game="${key}">
