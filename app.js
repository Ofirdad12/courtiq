...
document.querySelectorAll("[data-game]").forEach(b=>b.onclick=()=>{active=b.dataset.game;render();
if(new URLSearchParams(location.search).get("invite")) setTimeout(()=>openAccount("activate"),0);window.scrollTo(0,0)});
