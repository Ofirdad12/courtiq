...
try{
  ...
  if(savedPilot) games.pilot=JSON.parse(savedPilot);
}catch(e){console.warn("Could not restore pilot game",e)}
let active=games.pilot?"pilot":"g2";
